...
def quizzler():
    ...
    subprocess.run(['python', 'main.py','images/false.png', 'images/true.png' 'data.py', 'question_model.py', 'quiz_brain.py', 'ui.py', 'images'], cwd=quizzler_dir)
...
def kanye():
    kanye_dir = 'kanye'
    subprocess.run(['python', 'main.py', 'background.png', 'kanye.png'], cwd=kanye_dir)
...
def states():
    states_dir = 'states'
    subprocess.run(['python', 'main.py', '50_states.csv', 'states_to_learn.csv', 'blank_states_img.gif'], cwd=states_dir)
